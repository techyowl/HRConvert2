...
$ConvertDir0 = str_replace('..', '', $ConvertLoc.'/'.$SesHash);
$ConvertDir = str_replace('..', '', $ConvertDir0.'/'.$SesHash2.'/');
$ConvertTemp = $InstLoc.'/DATA';
$ConvertTempDir0 = str_replace('..', '', $ConvertTemp.'/'.$SesHash);
$ConvertTempDir = str_replace('..', '', $ConvertTempDir0.'/'.$SesHash2.'/');
$LogInc = '0';
...
$VideoArray = array('3gp', 'mkv', 'avi', 'mp4', 'flv', 'mpeg', 'wmv', 'mov', 'm4v', 'swf');
...
$convertArr = array('zip', 'rar', 'tar', 'bz', 'gz', 'bz2', '7z', 'iso', 'vhd', 'vdi', 'tar.bz2', 'tar.gz', 'txt', 'doc', 'docx', 'rtf', 'xls', 'xlsx', 'odf', 'ods', 
 ...
 '3gp', 'mkv', 'avi', 'mp4', 'flv', 'mpeg', 'wmv', 'svg', 'dxf', 'vdx', 'fig', '3ds', 'obj', 'collada', 'off', 'ply', 'stl', 'ptx', 'dxf', 'u3d', 'vrml', 'm4v', 'm4p', 'swf');
...
if (isset($_POST['convertSelected'])) {
  ...
  foreach ($_POST['convertSelected'] as $key => $file) {
    ...
    $videoarray =  array('3gp', 'mkv', 'avi', 'mp4', 'flv', 'mpeg', 'wmv', 'swf');
    $ModelArray = array('3ds', 'obj', 'collada', 'off', 'ply', 'stl', 'ptx', 'dxf', 'u3d', 'vrml');
